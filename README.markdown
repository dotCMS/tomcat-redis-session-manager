...
* tomcat-redis-session-manager-VERSION.jar (the JAR you generated by this project)
* jedis-4.2.0.jar 
* commons-pool2-2.11.1.jar 
* slf4j-api-1.7.32.jar 
* gson-2.8.9.jar

Alternatively, the following configuration parameters can be specified via Environment Variables or Java Properties in the dotCMS startup script:
